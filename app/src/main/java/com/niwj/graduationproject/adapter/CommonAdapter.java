...
public abstract class CommonAdapter<T> extends BaseAdapter {
    ...
    public static class ViewHolder {
         ...
         * 为View设置可显示
         */
        public ViewHolder setVisbility(int viewId, int visiblity) {
...
//            });
//            if (cachedImage == null) {
//                view.setImageResource(R.drawable.ic_fail);
//            } else {
...
//         * @return
//         */
//        public ViewHolder setImageByPicaso(int viewId, String url){
//            ImageView view = getView(viewId);
//            Object tag = new Object();
//            int size = DisplayUtil.dp2px(view.getContext(), 100);
